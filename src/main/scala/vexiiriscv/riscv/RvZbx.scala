...
object RvZbx {
  ...
  val BREV8   = TypeI(M"011010000111-----101-----0010011")
  ...
  val PACK    = TypeR(M"0000100----------100-----0110011")
  val PACKH   = TypeR(M"0000100----------111-----0110011")
  val PACKW   = TypeR(M"0000100----------100-----0111011")
  ...
  val UNZIP     = TypeI(M"000010001111-----101-----0010011")
  val XPERM4    = TypeR(M"0010100----------010-----0110011")
  val XPERM8    = TypeR(M"0010100----------100-----0110011")
  ...
  val ZIP       = TypeI(M"000010001111-----001-----0010011")
